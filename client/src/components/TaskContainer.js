...
//           if (this.props.status.name === 'expired') {
//             if (task.status === 'uncompleted' && new Date(task.due_date) < today) {
//               return task;
//             }
//           } else if (this.props.status.name === 'uncompleted') {
//               if (task.status === 'uncompleted' && new Date(task.due_date) >= today) {
//                 return task;
//               }
//           } else if (this.props.status.name === 'completed') {
//               if (task.status === 'completed') {
//                 return task;
//               } 
//           }
...
//             if (task[this.state.searchBy].toLowerCase().includes(this.state.searchKey.toLowerCase())) {
//               return task;
//             }
//           });
...
//     return (
//       <>
//         <div className={this.props.status.class}>  
//           <div className="header-container">
//             <h3 className="header-title text-center">{this.props.status.title}</h3>
//               <div className="form-group">
//                 <label htmlFor="search-categories">Search by: </label>
//                 <select className="form-control" name="searchBy" value={this.state.searchBy} onChange={this.handleInputChange}>
//                   <option value="title">Title</option>
//                   <option value="description">Description</option>
//                   <option value="due_date">Due Date</option>
//                 </select>
//               </div>
//               <div className="form-group">
//                 <input className="form-control border-light" type="text" placeholder="search" name="searchKey" value={this.state.searchKey} onChange={this.handleInputChange} />
//               </div>
//           </div>
//           <div className="task-container-content">
//             {
...
//                 return <TaskCard task={task} key={task.id} status={this.props.status} />
//               })) : <NoTask />
//             }
//           </div>
//         </div>
